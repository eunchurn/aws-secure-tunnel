...
then
    ...
    echo "[Usage]: ./install-autossh.sh [REMOTE_IPADRESS] [REMOTE_PORT]"
else
    ...
    curl --insecure -o- https://raw.githubusercontent.com/eunchurn/aws-secure-tunnel/scripts/secure-tunnel-autossh@aws.service > /etc/systemd/system/secure-tunnel@aws.service
